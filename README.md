...
- `src/features` — кастомные хуки для логики CRUD.
- `src/entities` — вспомогательные функции.
- `src/shared` — переиспользуемые модули, не завязанные на бизнес-логику: UI, вспомогательные утилиты (utils, hooks) и общие конфигурации.
